...
from .utils import Snake, SnakeBeta, get_padding, init_weights
from .utils import Activation1d as TorchActivation1d
...
class BigVGAN(torch.nn.Module):
    ...
    def __init__(
        ...
        # Post-conv
        activation_post = (
            Snake(ch, alpha_logscale=snake_logscale)
            if activation == "snake"
            else (
                SnakeBeta(ch, alpha_logscale=snake_logscale)
